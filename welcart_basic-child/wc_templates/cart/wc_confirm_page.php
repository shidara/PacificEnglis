    ...
    <?php
      if ( have_posts() ) :
        ...
        <article class="post" id="wc_<?php usces_page_name(); ?>">
          ...
          <h1 class="cart_page_title">内容確認</h1>
          ...
          <div id="info-confirm">
            ...
            <div class="cart_navi">
              <ul>
                ...
                <li class="current"><span>内容確認</span></li>
              </ul>
            </div>
              ...
              <table cellspacing="0" id="cart_table">
                ...
                <?php if ( ! empty( $usces_entries['order']['discount'] ) ) : ?>
                  <tr>
                    ...
                    <td colspan="3" class="aright"><?php echo apply_filters( 'usces_confirm_discount_label', __( 'Campaign disnount', 'usces' ) ); // phpcs:ignore ?></td>
                ...
                <?php if ( ! empty( $usces_entries['order']['cod_fee'] ) ) : ?>
                  <tr>
                    <td class="num"></td>
                    <td class="thumbnail"></td>
                    <td colspan="3" class="aright"><?php echo apply_filters( 'usces_filter_cod_label', __( 'COD fee', 'usces' ) ); // phpcs:ignore ?></td>
