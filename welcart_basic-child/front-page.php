  ...
  <ul>
    <li class="FixedNavigation__item FixedNavigation__item--logo">
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
        <img src="https://dummyimage.com/176x76/f27d53/fff.png" alt="パシフィックイングリッシュ ホーム" width="176" height="76" />
      </a>
    </li>

    <li class="FixedNavigation__item">
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
        <img src="https://dummyimage.com/170x72/f27d53/fff.png" alt="" width="170" height="72" class="FixedNavigation__itemThumbnail" />
...
<main class="pageContents Top">
      ...
      <div class="MainImageSlider swiper js-homeMainVisualSlider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <picture>
              <source srcset="https://dummyimage.com/1032x515/f00/fff.png" media="(min-width:600px)" type="image/webp">
          ...
          <div class="swiper-slide">
            <picture>
              <source srcset="https://dummyimage.com/1032x515/0f0/fff.png" media="(min-width:600px)" type="image/webp">
          ...
          <div class="progress js-progress MainImage__progress"><span></span></div>
        </div>
  ...
  <section class="Top__mainMessageSection">
    <h2 class="Top__mainMessageTitle Top__mainMessageTitle--smp">世界が広がる<br />英語で話そう!</h2>
    <h2 class="Top__mainMessageTitle Top__mainMessageTitle--pc">英語で世界が広がる<br />楽しい英語学習の第一歩</h2>
    ...
    <div class="Message__inner">
      <div class="Message__contents">
        <div class="Message__column">
          <div class="Message__columnItem">
            <p class="Message__subText">パシフィックイングリッシュだから</p>
            <p class="Message__title">こどもたちに愛と情熱を。<br />グローバル教育で<br />地域に愛され40年。</p>
          </div>
          <div class="Message__columnItem">
            <img src="https://dummyimage.com/390x300/f27d53/fff.png" width="390" height="300" loading="lazy" />
          </div>
        </div>
        ...
        <div class="Message__thumbnail"><img src="https://dummyimage.com/340x249/f27d53/fff.png" width="340" height="249" /></div>
      </div>
    </div>
  </section>
  ...
  <section class="Voice">
    ...
    <div class="Voice__contents">
      <div class="Voice__contentsItem">
        <div class="Voice__contentsItemInfo">
