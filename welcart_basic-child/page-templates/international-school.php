...
<main class="pageContents InternationalSchool">
  ...
  <section class="WeeklySchedule">
    <div class="WeeklySchedule__inner">
                ...
                <tr>
                  ...
                  <td class="WeeklySchedule__scheduleTableData WeeklySchedule__scheduleTableData--single" colspan="5">
                    <div class="WeeklySchedule__scheduleTableDataInner">
                      ...
                      <div class="WeeklySchedule__scheduleTableDataStamp"><img src="<?php echo $imgUri;?>/4.webp" alt="" loading="lazy" /></div>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="WeeklySchedule__scheduleTableData WeeklySchedule__scheduleTableData--single" colspan="5">
                    <div class="WeeklySchedule__scheduleTableDataInner">
                      ...
                      <div class="WeeklySchedule__scheduleTableDataStamp"><img src="<?php echo $imgUri;?>/3.webp" alt="" loading="lazy" /></div>
                    </div>
                  </td>
                </tr>
                <tr>
